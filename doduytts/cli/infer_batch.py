...
"""Batch inference CLI for DoDuyTTS.
...
from doduytts.models.doduytts import DoDuyTTS
from doduytts.utils.audio import load_audio
from doduytts.utils.common import get_best_device_with_count, str2bool
from doduytts.utils.data_utils import read_test_list
...
def get_parser():
    parser = argparse.ArgumentParser(description="Infer DoDuyTTS Model")
    parser.add_argument(
        "--model",
        type=str,
...
def process_init(rank_queue, model_checkpoint, warmup=0, enable_flashinfer=False):
    ...
    worker_model = DoDuyTTS.from_pretrained(
        model_checkpoint,
