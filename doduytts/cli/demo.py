...
"""
Gradio demo for DoDuyTTS.

Supports voice cloning and voice design.

Usage:
    doduytts-demo --model /path/to/checkpoint --port 8000
"""
...
from doduytts.utils.lang_map import LANG_NAMES, lang_display_name
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="doduytts-demo",
        description="Launch a Gradio demo for DoDuyTTS.",
...
def build_demo(
    ...
    with gr.Blocks(theme=theme, css=css, title="DoDuyTTS Demo") as demo:
        gr.Markdown(
            """
# DoDuyTTS Demo
